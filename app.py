...
def main():
    ...
    if sample_select == "Sample A: Smooth Voice (Genuine Sim)":
        ...
        if input_method == "📂 Upload File":
            ...
            st.markdown("""
            <div style="background-color: rgba(245, 158, 11, 0.05); border-left: 4px solid #f59e0b; padding: 15px; border-radius: 8px; margin-top: 15px; border: 1px solid rgba(245, 158, 11, 0.1);">
                <div style="font-weight: 700; color: #f59e0b; font-size: 0.85rem; margin-bottom: 5px; font-family: 'Syne', sans-serif;">
                    ⚠️ DISCLOSURE: MICROPHONE RE-RECORDING LIMITATION
                </div>
                <div style="font-size: 0.78rem; color: #cbd5e1; line-height: 1.45; font-family: 'Outfit', sans-serif;">
                    Recording audio via a microphone introduces physical room acoustics, echo, and speaker playback distortions. 
                    These environmental factors wash out the subtle high-frequency digital artifacts generated by AI vocoders. 
                    For maximum accuracy in detecting deepfakes, we highly recommend uploading the <b>direct digital audio file</b> using the <b>Upload File</b> tab.
                </div>
            </div>
            """, unsafe_allow_html=True)
